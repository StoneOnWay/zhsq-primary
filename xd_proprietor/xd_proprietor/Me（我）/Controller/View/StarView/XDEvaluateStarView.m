...
static NSString * const kStarImageStyleNormal = @"hui";
static NSString * const kStarImageStyleHighlight = @"jin";

@interface XDEvaluateStarView()
...
@implementation XDEvaluateStarView
