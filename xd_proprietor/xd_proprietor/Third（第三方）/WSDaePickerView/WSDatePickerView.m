...
-(instancetype)initWithDateStyle:(WSDateStyle)datePickerStyle withUnitData:(NSDate *)unitDate CompleteBlock:(void(^)(NSDate *))completeBlock {
    self = [super init];
    if (self) {
        self = [[[NSBundle mainBundle] loadNibNamed:NSStringFromClass([self class]) owner:self options:nil] lastObject];
        self.scrollToDate = unitDate;
...
-(void)setupUI {
    ...
    self.doneButtonColor = UIColorHex(007cc2);
...
//        label.textColor =  RGB(247, 133, 51);
        label.textColor = UIColorHex(007cc2);
