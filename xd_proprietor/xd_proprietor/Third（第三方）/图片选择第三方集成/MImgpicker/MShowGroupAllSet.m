...
//设置可添加图片最多个数!!!
#define kMaxCount [[NSUserDefaults standardUserDefaults] objectForKey:@"kMaxImageCount"];
...
- (void)viewDidLoad {
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:frame collectionViewLayout:flowOut];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.imavHead.image = [UIImage imageWithCGImage:set.aspectRatioThumbnail];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return CGSizeMake((wid-5*1)/4, (wid-5*1)/4);
}
